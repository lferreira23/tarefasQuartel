...
//    }
    ...
    private void BtBuscarSoldadoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtBuscarSoldadoActionPerformed
        ...
        rbMasculino.setSelected(milit.getSexo().equals("Masculino")?true:false);
        rbFeminino.setSelected(milit.getSexo().equals("Feminino")?true:false); 
    ...
    private void btSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSalvarActionPerformed
        ...
        cli.setRg(ftfRg.getText());
        cli.setNascimento(ftfNascimento.getText());
        cli.setSexo(rbMasculino.isSelected()?"Masculino":"Feminino");
        cli.setEstado((String)cbEstado.getSelectedItem());
        cli.setIdade(Integer.parseInt(ftfIdade.getText()));
        cli.setAlimentarCavalos(chkAlimentarCavalos.isSelected());
        cli.setCozinharArmoco(chkCozinharAlmoco.isSelected());
        cli.setCozinharJanta(chkCozinharJanta.isSelected());
        cli.setDescascar(chkDescascarBatatas.isSelected());
        cli.setLevantarBandeira(chkLevantarBandeira.isSelected());
        cli.setLimparBanheiro(chkLimparBanheiro.isSelected());
        cli.setLimparCozinha(chkLimparCozinha.isSelected());
        cli.setLimparEstabulos(chkLimparEstabulos.isSelected());
        cli.setRecarregarArmamento(chkRecarregar.isSelected());
        cli.setTrocarEncanamento(chkTrocarEncanamento.isSelected());
        
        try {
            Altera.alteraCliente(cli);
        } catch (SQLException ex) {
            Logger.getLogger(FrameCadastro.class.getName()).log(Level.SEVERE, null, ex);
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(FrameCadastro.class.getName()).log(Level.SEVERE, null, ex);
