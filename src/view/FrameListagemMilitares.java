...
/**
 * Frame Para mostrar todos os Militares.
 * @author Luiz Ferreira
 * @since 26/08/2017
 */
public class FrameListagemMilitares extends javax.swing.JFrame {

    /**
     * Creates new form FrameListagem
     */
    public FrameListagemMilitares(){
        initComponents();
        ...
        for(Militar militar : militarList) {
            tableModel.addRow(new Object[]{
                ...
                Utils.dateToString(militar.getNascimento()),
                militar.getIdade(),
                militar.getCpf(),
                militar.getRg(),
                militar.getEstado()
    ...
    private void initComponents() {
        ...
        setTitle("Militares Cadastrados");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nome", "Sexo", "Patente", "Nascimento", "Idade", "CPF", "RG", "Estado"
            }
        ) {
